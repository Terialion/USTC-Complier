...
void translate_main(CodeGen *codegen) {
    ...
    offset_map["%op0"] = -48;  // TODO: 请填空
    offset_map["*%op0"] = -40; // TODO: 请填空
    ...
    codegen->append_inst("ld.w", {"$t1", "$fp", std::to_string(offset_map["%op1"])});
    codegen->append_inst("movgr2fr.w $ft1, $t1");
    codegen->append_inst("ftintrz.w.s $ft0, $ft1");
    codegen->append_inst("movfr2gr.s $t1, $ft0");
